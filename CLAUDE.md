...
| [dlt_ingestion_framework/templates/dlt_pipeline.sql.j2](dlt_ingestion_framework/templates/dlt_pipeline.sql.j2) | Renders the full DLT SQL file (Bronze → Cleaned View → Quarantine → Silver) |
...
5. Jinja2 renders the five templates into output files written to `src/` and `resources/`.
